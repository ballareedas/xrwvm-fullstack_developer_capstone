...
// ✅ Optional Seeding (only if env variable is set or running locally)
const isRender = process.env.RENDER === 'true';
const shouldSeed = process.env.SEED_DATA === 'true' || !isRender;
...
if (shouldSeed) {
  (async () => {
    try {
      ...
      console.log("🌱 Initial data inserted (reviews + dealerships)");
    } catch (error) {
      console.error("❌ Error inserting initial data:", error);
    }
  })();
